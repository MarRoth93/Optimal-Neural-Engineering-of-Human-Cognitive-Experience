...
def main():
    ...
    base_in = Path(f'/home/rothermm/brain-diffuser/results/vdvae/subj{sub:02d}/emonet')
    base_out = Path(f'/home/rothermm/brain-diffuser/results/versatile_diffusion/subj{sub:02d}/emonet')
