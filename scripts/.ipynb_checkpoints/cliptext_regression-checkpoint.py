...
train_clip = np.load('/home/rothermm/brain-diffuser/data/extracted_features/subj{:02d}/nsd_cliptext_train.npy'.format(sub))
test_clip = np.load('/home/rothermm/brain-diffuser/data/extracted_features/subj{:02d}/nsd_cliptext_test.npy'.format(sub))
...
np.save('/home/rothermm/brain-diffuser/data/predicted_features/subj{:02d}/nsd_cliptext_predtest_nsdgeneral.npy'.format(sub),pred_clip)
...
with open('/home/rothermm/brain-diffuser/data/regression_weights/subj{:02d}/cliptext_regression_weights.pkl'.format(sub),"wb") as f:
