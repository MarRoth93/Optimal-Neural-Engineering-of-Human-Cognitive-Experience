...
nsd_features = np.load('/home/rothermm/brain-diffuser/data/extracted_features/subj{:02d}/nsd_vdvae_features_31l.npz'.format(sub))
...
np.save('/home/rothermm/brain-diffuser/data/predicted_features/subj{:02d}/nsd_vdvae_nsdgeneral_pred_sub{}_31l_alpha50k.npy'.format(sub,sub),pred_latents)
...
with open('/home/rothermm/brain-diffuser/data/regression_weights/subj{:02d}/vdvae_regression_weights.pkl'.format(sub),"wb") as f:
