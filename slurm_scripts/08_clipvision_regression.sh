...
#SBATCH --job-name=07_clipvision_regression
#SBATCH --ntasks=1
...
for sub in "${subjects[@]}"; do
    ...
    python -u /home/rothermm/brain-diffuser/scripts/08_clipvision_regression.py --sub "$sub" \
    ...
    if [ "${PIPESTATUS[0]}" -ne 0 ]; then
        echo "!! ERROR: CLIP vision regression for subject $sub failed"
