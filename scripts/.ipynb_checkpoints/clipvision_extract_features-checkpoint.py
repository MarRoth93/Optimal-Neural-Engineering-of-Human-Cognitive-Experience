...
with torch.no_grad():
    ...
    np.save('/home/rothermm/brain-diffuser/data/extracted_features/subj{:02d}/nsd_clipvision_test.npy'.format(sub),test_clip)
    ...
    np.save('/home/rothermm/brain-diffuser/data/extracted_features/subj{:02d}/nsd_clipvision_train.npy'.format(sub),train_clip)
